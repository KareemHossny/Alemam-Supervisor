...
const ReviewDailyTasks = () => {
  ...
  const viewTaskDetails = (taskId) => {
    navigate(`/dashboard/task-details/daily/${taskId}`);
  };
                ...
                <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 w-full sm:w-auto">
                  ...
                  {task.status === 'pending' && (
                    <button
                      ...
                      className="flex items-center justify-center gap-2 px-3 sm:px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg sm:rounded-xl transition-colors w-full sm:w-auto text-xs sm:text-sm"
                    >
